package com.datastax.killrvideo.it.async;
...
public class KillrVideoThreadFactory implements ThreadFactory {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("killrvideoit-default-executor");
    ...
    public Thread newThread(Runnable r) {
        ...
        thread.setName("killrvideoit-default-executor-" + this.threadNumber.incrementAndGet());
